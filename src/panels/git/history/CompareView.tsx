// Сравнение двух состояний репозитория и редактор сообщения коммита.
// Обе вертикали про «переписать прошлое»: сравнение показывает, что выйдет,
// редактор меняет уже записанное.
