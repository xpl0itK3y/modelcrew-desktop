// Аватар автора коммита. Показывается и в строке графа, и в раскрытой
// карточке, и в шапке сравнения.
//
// Реальная картинка (GitHub/Gravatar) — только для вошедшего через GitHub
// пользователя и при включённой настройке «Из сети». Иначе (не вошёл, офлайн,
// нет аватара, опция «Инициалы») — цветной кружок с инициалами.
