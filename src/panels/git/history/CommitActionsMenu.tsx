// Меню действий над коммитом. Почти каждое из них переписывает историю,
// поэтому идёт через подтверждение с текстом о последствиях, а недоступные
// для запушенного или для отделённого HEAD не показываются вовсе.
