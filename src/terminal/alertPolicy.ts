...
// Пользователь и так смотрит на панель — не спамим. Скрытая панель зовёт даже
// при активном окне: она в другой сессии, её не видно.
export function isPanelWatched(
  context: AgentAlertContext,
  windowFocused: boolean,
): boolean {
  return context.visible && windowFocused;
}
