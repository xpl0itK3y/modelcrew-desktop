...
const gitReasonKeys: Record<string, MessageKey> = {
  ...
  "merge-conflict": "error.gitMergeConflict",
  "rebase-conflict": "error.gitRebaseConflict",
  "upstream-exists": "error.gitUpstreamExists",
  "remote-missing": "error.gitRemoteMissing",
  "remote-ambiguous": "error.gitRemoteAmbiguous",
  "published-untracked": "error.gitPublishedUntracked",
  "ref-kind-invalid": "error.gitRefKindInvalid",
  ...
  "unresolved-conflicts": "error.gitUnresolvedConflicts",
  "no-operation": "error.gitNoOperation",
  "operation-needs-commit": "error.gitOperationNeedsCommit",
