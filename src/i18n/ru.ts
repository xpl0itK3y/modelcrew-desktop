...
export const ru = {
  ...
  "snapshots.tab": "Снимки",
  "snapshots.empty": "Снимков пока нет. Они появляются после каждого хода агента.",
  "snapshots.noFiles": "Ход ничего не изменил",
  "snapshots.unknownPanel": "Панель {id}",
  "snapshots.restore": "Вернуть",
  "snapshots.restoring": "Возвращаю…",
  "snapshots.restoreHint": "Записать эту версию файла {path} в рабочее дерево",
  "crew.holding": "Правит:\n{paths}",
