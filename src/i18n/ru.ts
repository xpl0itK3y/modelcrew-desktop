...
export const ru = {
  ...
  "settings.agentHook": "Уведомления от {agent}",
  "settings.agentHookNote":
    "Агент сам сообщит, что закончил ход или ждёт ответа. Без этого приложение только угадывает по выводу панели: звонок или затянувшаяся тишина.",
  "settings.agentHookFile": "Правится файл {file}; копия до правки остаётся рядом.",
  "settings.agentHookFailed":
    "Не удалось изменить конфиг агента — он остался как был. Проверьте права на файл и что это корректный JSON.",
