...
export const ru = {
  ...
  "git.pullRebaseHint": "Переложить ваши коммиты поверх серверных (при конфликте откатится)",
  "git.resetToServer": "Сбросить к серверу",
  "git.resetToServerHint": "Отбросить локальные коммиты и несохранённые правки, стать точно как сервер (коммиты восстановимы через reflog)",
  "git.resetConfirm": "Отбросить локальное?",
