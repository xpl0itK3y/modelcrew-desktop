...
export const en: Record<MessageKey, string> = {
  ...
  "snapshots.empty": "No snapshots yet. One is taken after every agent turn.",
  "snapshots.noFiles": "The turn changed nothing",
  "snapshots.unknownPanel": "Panel {id}",
  "snapshots.restore": "Restore",
  "snapshots.restoring": "Restoring…",
  "snapshots.restoreHint": "Write this version of {path} back into the working tree",
