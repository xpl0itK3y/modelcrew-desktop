...
const ru = {
  ...
  "error.terminalAlreadyExists": "Терминал уже существует",
...
const en: Record<MessageKey, string> = {
  ...
  "error.terminalAlreadyExists": "The terminal already exists",
...
const backendErrorKeys: Record<string, MessageKey> = {
  ...
  terminal_already_exists: "error.terminalAlreadyExists",
